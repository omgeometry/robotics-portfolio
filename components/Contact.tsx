    ...
    <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12">
          {/* Email */}
          <a
            href="mailto:channingtan@gmail.com"
            className="bg-slate-800/50 border border-slate-700 rounded-lg p-6 hover:border-blue-500 transition-all text-center group"
          >
            ...
            <p className="text-slate-400 text-sm break-all">channingtan@gmail.com</p>
          </a>
          ...
          >
            ...
            <p className="text-slate-400 text-sm">github.com/omgeometry</p>
          </a>
          ...
          >
            ...
            <p className="text-slate-400 text-sm">Channing Tan</p>
          </a>
        </div>
